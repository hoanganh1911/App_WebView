...
document.addEventListener('DOMContentLoaded', function() { //Khi khởi tạo HTML thành công ko chờ các thành phần như stylesheet,images và subframes
    ...
    firebase.database().ref().on('value', (snapshot) => { //Lấy dữ liệu realtime và xử lý
        ...
        function writeUserLedStatusData(sts) { //Ghi trạng thái led vào server
        ...
        if (modeValue == 0) { //Với trường hợp thao tác bằng tay => Thực hiện được nút bấm, giới hạn nhiệt độ từ -20 - 60 , độ ẩm 0-100
